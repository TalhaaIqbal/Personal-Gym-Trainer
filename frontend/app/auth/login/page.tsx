                        ...
                        <div className="mt-6">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-2 bg-blue-900/50 text-blue-200">Or continue with</span>
                                </div>
                            </div>
                            ...
                            <div className="mt-6 grid grid-cols-2 gap-3">
                                <button
                                    type="button"
                                    className="flex items-center justify-center px-4 py-2 bg-blue-800/50 border border-blue-600/50 rounded-lg text-white hover:bg-blue-700/50 transition-all duration-300"
                                >
